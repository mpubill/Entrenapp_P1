...
public class ej1casa_principianteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ej1casa_principiante);
        ...
        CargarVideos("Ex2BKaNX8xA", video1);
        CargarVideos("Ex2BKaNX8xA", video2);
        CargarVideos("Ex2BKaNX8xA", video3);
    }
